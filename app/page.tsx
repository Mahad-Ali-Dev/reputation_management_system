...
import { LandingOrbit } from "@/components/landing/sections/orbit";
 ...
 *   - Integrations→ mockup grid + IntegrationHero dual counter-scroll marquee
 *   - Orbit       → FeatureSection spinning orbit rings (brand icons)
 ...
 * plus #command #orbit #tour #explore #ai for the dropdown/deep links.
 */
