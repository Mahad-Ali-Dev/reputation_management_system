...
const PAGES: Entry[] = [
  ...
  { path: "/docs/concepts", priority: 0.6, changeFrequency: "monthly" },
  { path: "/docs/hardware", priority: 0.6, changeFrequency: "monthly" },
  { path: "/docs/ai-training", priority: 0.6, changeFrequency: "monthly" },
  { path: "/docs/phone", priority: 0.6, changeFrequency: "monthly" },
