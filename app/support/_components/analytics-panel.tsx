...
/**
 * Support analytics panel (Module 09 — Unified Inbox, "Analytics" view).
 *
 * Folded INTO the unified workspace as a secondary management view. The body is
 * the same SocialComment/InboxThread analytics that previously lived at
 * `/support/analytics` (now a redirect into `/support?tab=analytics`) — query,
 * KPIs, charts and breakdowns moved here verbatim so behaviour is unchanged.
 *
 * SERVER component: DB reads only (RSC-safe).
 *
